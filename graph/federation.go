...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Vehicle":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Vehicle": %w`, err)
			}
			switch resolverName {

			case "findVehicleByID":
				id0, err := ec.unmarshalNBigInt2int(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findVehicleByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindVehicleByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Vehicle": %w`, err)
				}
...
func entityResolverNameForVehicle(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
	...
	return "", fmt.Errorf("%w for Vehicle", ErrTypeNotFound)
}
