...
//
//	mockgen -destination=./graph/mock_devicedefinition_test.go -package=graph github.com/DIMO-Network/identity-api/graph DeviceDefinitionRepository
//
...
func (m *MockDeviceDefinitionRepository) GetDeviceDefinitions(ctx context.Context, manufacturerTokenID int, first *int, after *string, last *int, before *string, filterBy *model.DeviceDefinitionFilter) (*model.DeviceDefinitionConnection, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceDefinitions", ctx, manufacturerTokenID, first, after, last, before, filterBy)
...
func (mr *MockDeviceDefinitionRepositoryMockRecorder) GetDeviceDefinitions(ctx, manufacturerTokenID, first, after, last, before, filterBy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeviceDefinitions", reflect.TypeOf((*MockDeviceDefinitionRepository)(nil).GetDeviceDefinitions), ctx, manufacturerTokenID, first, after, last, before, filterBy)
}
