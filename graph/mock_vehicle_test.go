...
func (m *MockVehicleRepository) GetVehicle(arg0 context.Context, arg1 int) (*model.Vehicle, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVehicleRepositoryMockRecorder) GetVehicle(arg0, arg1 any) *gomock.Call {
