...
type ComplexityRoot struct {
	...
	Entity struct {
		FindVehicleByID func(childComplexity int, id int) int
	}
...
type EntityResolver interface {
	FindVehicleByID(ctx context.Context, id int) (*model.Vehicle, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Entity.findVehicleByID":
		if e.complexity.Entity.FindVehicleByID == nil {
			break
		}

		args, err := ec.field_Entity_findVehicleByID_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Entity.FindVehicleByID(childComplexity, args["id"].(int)), true
...
type Entity {
		findVehicleByID(id: BigInt!,): Vehicle!
...
func (ec *executionContext) field_Entity_findVehicleByID_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) _Entity_findVehicleByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Entity_findVehicleByID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().FindVehicleByID(rctx, fc.Args["id"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
