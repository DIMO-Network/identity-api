...
func (m *MockManufacturerRepository) GetManufacturers(arg0 context.Context) (*model.ManufacturerConnection, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetManufacturers", arg0)
...
func (mr *MockManufacturerRepositoryMockRecorder) GetManufacturers(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetManufacturers", reflect.TypeOf((*MockManufacturerRepository)(nil).GetManufacturers), arg0)
}
