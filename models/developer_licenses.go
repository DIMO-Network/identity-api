...
func FindDeveloperLicense(ctx context.Context, exec boil.ContextExecutor, tokenID int, selectCols ...string) (*DeveloperLicense, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"identity_api\".\"developer_licenses\" where \"token_id\"=$1", sel,
	)
...
func (o *DeveloperLicense) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"identity_api\".\"developer_licenses\" WHERE \"token_id\"=$1"
...
func (o *DeveloperLicense) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindDeveloperLicense(ctx, exec, o.TokenID)
	if err != nil {
		return err
	}
...
func DeveloperLicenseExists(ctx context.Context, exec boil.ContextExecutor, tokenID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"identity_api\".\"developer_licenses\" where \"token_id\"=$1 limit 1)"
...
func (o *DeveloperLicense) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return DeveloperLicenseExists(ctx, exec, o.TokenID)
}
