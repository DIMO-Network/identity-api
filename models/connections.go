...
var ConnectionWhere = struct {
	...
	Name:     whereHelperstring{field: "\"identity_api\".\"connections\".\"name\""},
...
var (
	connectionAllColumns            = []string{"name", "address", "owner", "minted_at"}
	connectionColumnsWithoutDefault = []string{"name", "address", "owner", "minted_at"}
	connectionColumnsWithDefault    = []string{}
	connectionPrimaryKeyColumns     = []string{"name"}
...
func FindConnection(ctx context.Context, exec boil.ContextExecutor, name string, selectCols ...string) (*Connection, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"identity_api\".\"connections\" where \"name\"=$1", sel,
	)
...
func (o *Connection) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"identity_api\".\"connections\" WHERE \"name\"=$1"
...
func (o *Connection) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindConnection(ctx, exec, o.Name)
	if err != nil {
		return err
	}
...
func ConnectionExists(ctx context.Context, exec boil.ContextExecutor, name string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"identity_api\".\"connections\" where \"name\"=$1 limit 1)"
...
func (o *Connection) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return ConnectionExists(ctx, exec, o.Name)
}
