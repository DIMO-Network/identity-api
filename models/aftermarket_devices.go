...
var (
	aftermarketDeviceAllColumns            = []string{"id", "address", "owner", "serial", "imei", "minted_at"}
	aftermarketDeviceColumnsWithoutDefault = []string{"id"}
	aftermarketDeviceColumnsWithDefault    = []string{"address", "owner", "serial", "imei", "minted_at"}
