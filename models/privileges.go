...
var (
	privilegeAllColumns            = []string{"id", "token_id", "privilege_id", "granted_to_address", "set_at", "expires_at"}
	privilegeColumnsWithoutDefault = []string{"id", "token_id", "privilege_id", "granted_to_address", "set_at", "expires_at"}
